...
public class ClienteControllerTestUnitaria {
    ...
    public void setUp(){
        ...
        cliente.setNombre("pe");
        cliente.setApellido("perro");
        cliente.setDireccion("av. los guas");
        cliente.setTelefono("0979332474");
        cliente.setCorreo("perro@perro.com");
    ...
    public void testSave(){
        ...
        assertEquals(200, respuesta.getStatusCodeValue());
        assertEquals("pe", respuesta.getBody().getNombre());
    }
